                    ...
                    <ion-row>
                        <ion-col size="6" size-xm="6">
                            ...
                            <ion-card>
                                ...
                                <ion-card-header>
                                    <ion-card-subtitle>Postres</ion-card-subtitle>
                                    <ion-card-title>Pastel</ion-card-title>
                                </ion-card-header>
                        ...
                        <ion-col size="6" size-xm="6">
                            <ion-card>
                                ...
                                <ion-card-header>
                                    <ion-card-subtitle>Postres</ion-card-subtitle>
                                    <ion-card-title>Muffin</ion-card-title>
                                </ion-card-header>
                        ...
                        <ion-col size="6" size-xm="6">
                            <ion-card>
                                ...
                                <ion-card-header>
                                    <ion-card-subtitle>Postres</ion-card-subtitle>
                                    <ion-card-title>Chocolate</ion-card-title>
                                </ion-card-header>
                        ...
                        <ion-col size="6" size-xm="6">
                            <ion-card>
                                ...
                                <ion-card-header>
                                    <ion-card-subtitle>Postres</ion-card-subtitle>
                                    <ion-card-title>Dulce</ion-card-title>
                                </ion-card-header>
